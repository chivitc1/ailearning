...
def main():
    ...
    classifier_model = neighbors.KNeighborsClassifier(num_neighbors, weights='distance')
    ...
    output = classifier_model.predict(np.c_[x_values.ravel(), y_values.ravel()])
    ...
    _, indices = classifier_model.kneighbors([test_datapoint])
    # to vector
    ...
    print("Predicted output:", classifier_model.predict([test_datapoint])[0])
